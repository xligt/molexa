...
class Attention_Block(nn.Module):
    def __init__(self, att_dim, nheads=1, dot_product=True, res=True, act1=nn.ReLU, act2=None, norm=LayerNorm, norm_dim=-1, rga='n (h d) -> h n d', rgb='h n d -> n (h d)'):
        super().__init__()      
        ...
        self.Prj_postAtt = ResLayer(self.att_dim, self.att_dim, res=res, act1=act1, act2=act2, norm=norm, norm_dim=norm_dim)        
